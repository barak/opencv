...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib cxcore.lib /nologo /subsystem:windows /dll /debug /machine:I386 /nodefaultlib:"libmmd.lib" /out:"..\..\bin\cv096.dll" /implib:"../../lib/cv.lib" /libpath:"..\..\lib"
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib cxcored.lib /nologo /subsystem:windows /dll /debug /machine:I386 /nodefaultlib:"libmmdd.lib" /out:"..\..\bin\cv096d.dll" /implib:"../../lib/CVd.lib" /libpath:"..\..\lib"
