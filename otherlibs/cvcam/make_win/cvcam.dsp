...
# ADD CPP /nologo /MD /W3 /GX /O2 /I "../include" /I "../../highgui" /I "../../../cv/include" /I "../../../Filters\ProxyTrans" /I "..\..\..\Filters\SyncFilter" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "CVCAM_EXPORTS" /FD /c
# SUBTRACT CPP /YX
...
# ADD CPP /nologo /MDd /W3 /GX /Od /I "../include" /I "../../highgui" /I "../../../cv/include" /I "../../../Filters\ProxyTrans" /I "..\..\..\Filters\SyncFilter" /D "WIN32" /D "DEBUG" /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /D "CVCAM_EXPORTS" /FD /GZ /c
...
# ADD LINK32 highguid.lib kernel32.lib user32.lib gdi32.lib comdlg32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib quartz.lib advapi32.lib winmm.lib STRMBASD.LIB /nologo /dll /machine:I386 /nodefaultlib:"libcmtd" /out:"..\..\..\bin\cvcamd.dll" /implib:"..\..\..\lib\cvcamd.lib" /libpath:"../../../lib"
# SUBTRACT LINK32 /pdb:none /incremental:no /debug /nodefaultlib /force
